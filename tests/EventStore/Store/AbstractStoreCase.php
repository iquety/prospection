...
abstract class AbstractStoreCase extends EventStoreCase
{
    ...
    public function remove(): void
    {
        ...
        $this->assertSame(1, $list[4]['version']);
        $this->assertSame('2022-10-10 01:10:10.000000', $list[4]['occurredOn']);
        $this->assertSame(2, $list[5]['version']);
        $this->assertSame('2022-10-10 02:10:10.000000', $list[5]['occurredOn']);
        $this->assertSame(3, $list[6]['version']);
        $this->assertSame('2022-10-10 03:10:10.000000', $list[6]['occurredOn']);
        $this->assertSame(4, $list[7]['version']);
        $this->assertSame('2022-10-10 04:10:10.000000', $list[7]['occurredOn']);
